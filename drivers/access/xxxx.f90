  ...
  do k = 1, nblocks
    if (maice(i,j,k)==0.0) then
      ...
      do cat = 1, ncat
        ...
        flatn_f(i,j,cat,k) = um_iceevp(i,j,cat,k) * Lsub !!!* maicen(i,j,cat,k)/maice(i,j,k) 
      enddo
    endif
  enddo
enddo
...
!B: =========== may use different formula for Tf ===============
  ...
  do k = 1, nblocks
    if (aice(i,j,k)==0.0) then
      ...
      do cat = 1, ncat
        ...
        flatn_f(i,j,cat,k) = um_iceevp(i,j,cat,k) * Lsub !!!*aicen(i,j,cat,k)/aice(i,j,k) 
      enddo
    endif
  enddo
enddo
